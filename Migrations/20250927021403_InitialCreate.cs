    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 2, "Lima", "DEP001", "Av. Principal 123", 2, "dep1.jpg", 80, 150000m, 0, "Departamento céntrico" },
                    { 2, true, 3, "Arequipa", "CASA002", "Calle Secundaria 45", 3, "casa2.jpg", 120, 250000m, 1, "Casa familiar" },
                    { 3, true, 2, "Lima", "OFI003", "Av. Empresarial 789", 0, "ofi3.jpg", 60, 100000m, 2, "Oficina moderna" },
                    { 4, true, 1, "Cusco", "LOC004", "Jr. Comercio 10", 0, "loc4.jpg", 40, 80000m, 3, "Local comercial" }
                });
